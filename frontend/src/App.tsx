...
import AIInsights from "./pages/dashboards/user/AIInsights";
...
// ========== AUTHENTICATION ONLY (no ServiceProvider) ==========
...
const ProtectedRoute: React.FC<ProtectedRouteProps> = ({
  ...
  // ✅ No ServiceProvider here – just render children
  return children;
};

// ========== LAYOUT WITH ServiceProvider ==========
    ...
    <BrowserRouter>
      <AuthProvider>
        <Routes>
          ...
          {/* ========== MAIN APP (authenticated + ServiceProvider) ========== */}
          <Route
            path="/app"
            element={
              <ProtectedRoute>
          ...
          >
            ...
            {/* Role‑specific routes – only auth check, ServiceProvider already active */}
            <Route
              path="logs"
              element={
                <ProtectedRoute
            ...
            />
            {/* Reports route – now ServiceProvider is guaranteed */}
            <Route
              path="reports"
              element={
                <ProtectedRoute
            ...
            {/* Other role‑specific routes (unchanged) */}
            <Route
              path="team"
              element={
